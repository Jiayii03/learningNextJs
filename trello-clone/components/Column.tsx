...
// creates a mapping from values of type TypedColumn to strings
// idToColumnText['todo'] => 'To do'
      ...
      {(provided) => (
        ...
        >
          <Droppable droppableId={index.toString()} type="card">
            {(
              provided,
              snapshot // snapshot is for when the element is dragged
            ) => (
              <div
                ...
                <div className="space-y-2">
                  {todos.map((todo, index) => {
                    ...
                    return (
                      ...
                      >
                        {(provided) => (
                          // depending on how many elements in the todos list, there will be that many ToDoCard components
                          <ToDoCard
                            todo={todo}
                            index={index}
                            id={id}
